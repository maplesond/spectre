...
public class Chopper {
        ...
        while ((aLine = in.readLine()) != null) {
            ...
            if (sT.hasMoreTokens()) {
                ...
                if (sT.hasMoreTokens()) {
                    ...
                    System.out.println("QNet.Chopper: Script line lacking file name!");
    ...
    public static void printQuartets(String fileName, QuartetWeights qW, LinkedList taxonNames) {
        ...
        try {
            ...
            System.out.println("Error while printing quartets!");
            System.exit(1);
    ...
    public static void printInformation(String fileName, QuartetWeights summer, LinkedList taxonNames) {
