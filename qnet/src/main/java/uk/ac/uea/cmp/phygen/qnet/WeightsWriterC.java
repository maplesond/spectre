            ...
            for (int j = i + 1; j <= Math.min(N - 1, N + i - 3); j++) {
                ...
                if (useMax) {
                    ...
                    wMin = theQuartetWeights.getWeight(x, y, u, v)
                           - Math.min(theQuartetWeights.getWeight(x, u, y, v),
                                      theQuartetWeights.getWeight(x, v, y, u));

                } else {

                    wMin = -theQuartetWeights.getWeight(x, y, u, v)
                           + Math.max(theQuartetWeights.getWeight(x, u, y, v),
                                      theQuartetWeights.getWeight(x, v, y, u));
                        ...
                        for (int n = 0; n < outside.size() - 1; n++) {
                            ...
                            for (int p = n + 1; p < outside.size(); p++) {
                                ...
                                if (useMax) {
                                    ...
                                    aWeight = theQuartetWeights.getWeight(x, y, u, v)
                                              - Math.min(theQuartetWeights.getWeight(x, u, y, v),
                                                         theQuartetWeights.getWeight(x, v, y, u));
