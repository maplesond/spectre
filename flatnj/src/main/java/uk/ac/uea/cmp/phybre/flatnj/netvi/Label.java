...
public class Label extends Element
{
    ...
    uk.ac.uea.cmp.phybre.flatnj.fdraw.Label label;
     ...
     * @param drawing 
     */
    public Label(uk.ac.uea.cmp.phybre.flatnj.fdraw.Label label, Window drawing)
    {
        name = label.getName();
        this.label = label;
     ...
     */
    public void setCoordinates(double x, double y, Collection<Label> labels)
    {
        setOffX(x - p.getX());
        setOffY(y - p.getY());
     ...
     * @param labels set of labels.
     */
    public void setCoordinatesAutomatic(int x, int y, Collection<Label> labels)
    {
        if(label.movable)
        {
            setOffX(x - p.getX());
     ...
     * @param labels 
     */
    public void checkForLeader(Collection<Label> labels)
    {
    ...
    private boolean closerToSomeOtherPoint(double x2, double y2, double minD, Collection<Label> labels)
    {
        double c = 1.3;
        minD *= c;
    ...
    public void distance()
    {
        ...
        Point intersection = intersectionPoint(x1, y1, x2, y1, mx, my, p.getX(), p.getY());
    ...
    public static Point intersectionPoint(double x1, double y1, double x2, double y2,
    ...
    Point computeBendingPoint(double cx, double cy, boolean bended)
    {
        int bx;
        int by;
    ...
    void computeOffsets(double x1, double y1, Collection<Label> labels)
    {
        setOffX(x1 - p.getX());
    ...
    void changePositionsWith(Label l2)
    {
