...
public class PermutationSequence {
    ...
    public double getFitRestrictionFor1(int a, int b, int x1, int x2, Quadruple q, SplitSystem ss) {
    ...
    public double getFitRestrictionFor2(int a, int b, int x1, int x2, Quadruple q, SplitSystem ss) {
        int min = (a < b) ? a : b;
        int max = (a > b) ? a : b;
    ...
    public void filterSplits(double threshold) {
        ...
        SplitSystem ss = new SplitSystem(this);
