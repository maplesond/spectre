...
SPECTRE's source code is written primarily in Java and is freely available under the
`GNU GPLv3 license <https://www.gnu.org/licenses/gpl-3.0.en.html>`_ via `github <https://github.com/maplesond/spectre>`_.
In addition our core data structures, algorithms and IO routines available as a library via `Maven <https://mvnrepository.com/artifact/uk.ac.uea.cmp.spectre/core>`_,
should user's which to easily leverage our code in their own projects.
