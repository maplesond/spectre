# -*- coding: utf-8 -*-
#
# phygen documentation build configuration file, created by
...
latex_documents = [
  ('index', 'phygen.tex', u'phygen Documentation',
...
man_pages = [
    ('index', 'phygen', u'phygen Documentation',
...
texinfo_documents = [
  ('index', 'phygen', u'phygen Documentation',
   u'Sarah Bastkowski, Daniel Mapleson, Monica Balvociute, Andreas Spillner', 'phygen', 'One line description of project.',
   'Miscellaneous'),
]
