...
//        }
    ...
    public FlatSplitSystem(boolean[][] splits, double[] weights) {
    ...
    public FlatSplitSystem(boolean[][] splits, double[] weights, int[] cycle) {
        nSplits = splits.length;
        nTaxa = splits[0].length;
...
//        }
    ...
    public double equalSplits(FlatSplitSystem ss) {
...
//            }
    ...
    public int falseSplits(FlatSplitSystem ss) {
        int falseSplits = 0;
    ...
    public double whatDoWeGetBackWithTrivial(FlatSplitSystem ss) {
        double atAll = 0;
        double getBack = 0;
    ...
    public double whatDoWeGetBack2(FlatSplitSystem ss) {
        double atAll = 0;
        double getBack = 0;
    ...
    public double whatDoWeGetBackWithoutTrivial(FlatSplitSystem ss) {
        double atAll = 0;
        double getBack = 0;
    ...
    public double whatDoWeGetBackUnit(FlatSplitSystem ss) {
        int atAll = 0;
        int getBack = 0;
    ...
    public double whatDoWeGetBackUnitThree(FlatSplitSystem ss1, FlatSplitSystem ss2) {
        int atAll = 0;
        int getBack = 0;
    ...
    public double whatDoWeGetBackWithoutTrivialUnit(FlatSplitSystem ss) {
        int atAll = 0;
        int getBack = 0;
    ...
    public FlatSplitSystem cutUnimportantSplits(double fraction) {
        ...
        FlatSplitSystem ssNew = new FlatSplitSystem();
    ...
    public double same(FlatSplitSystem ss) {
        double same = 0;
    ...
    public double same(FlatSplitSystem ss1, FlatSplitSystem ss2) {
        double same = 0;
    ...
    public double whatDoWeGetBackNoTrivialWithWeightThreshold(FlatSplitSystem ss, double tolerance) {
        int atAll = 0;
        int getBack = 0;
    ...
    public double leastSquaresDifference(FlatSplitSystem ss) {
        int diff = 0;
        int getBack = 0;
    ...
    public int commonSplits(FlatSplitSystem ss2) {
        int atAll = 0;
        int getBack = 0;
    ...
    public int commonSplitsSimilarityThreshold(FlatSplitSystem ss2, double threshold) {
        return similarSplits(ss2, threshold).size();
    }

    public Set<Integer> similarSplits(FlatSplitSystem ss2, double threshold) {
