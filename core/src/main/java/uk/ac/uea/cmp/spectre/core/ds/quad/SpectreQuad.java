 ...
 */
public class SpectreQuad implements Quad {
    ...
    public SpectreQuad(int a, int b, int c, int d) {

        this.setCanonically(a, b, c, d);
    }

    public SpectreQuad(int[] elements) {
    ...
    @Override
    public Quad createSortedCopy() {

        SpectreQuad newQuartet = new SpectreQuad(this);
    ...
    public int getGroupIndex() {
        ...
        Quad sorted = this.createSortedCopy();
    ...
    public Pair<Quad, Integer> getGroupKeys() {
