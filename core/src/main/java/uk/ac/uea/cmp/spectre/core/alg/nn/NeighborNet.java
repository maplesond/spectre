...
public interface NeighborNet {
    ...
    /**
     * Neighbornet takes in a distance matrix (which will have a set of taxa embedded within it).  The result of
     * neighbornet is a compatible split system which should contain a circular ordering
     *
     ...
     */
    SplitSystem execute(final DistanceMatrix distanceMatrix);
