...
public class Utilities {
    ...
    public static void setActive(int[] active, FlatSplitSystem ss, double threshold) {
        boolean current;
    ...
    public static void setActive(boolean[] active, FlatSplitSystem ss, double threshold) {
        boolean current;
        double[] weights = ss.getWeights();
        for (int i = 0; i < active.length; i++) {
            active[i] = true;
    ...
    public static void printFlatSplitsInNexusToTheScreen(FlatSplitSystem ss, PermutationSequence ps) {
    ...
    public static void printSplitSystemInNexus(FlatSplitSystem ss, String outputSplitsFile, double threshold) throws IOException {
    ...
    public static Set<Integer> getUnique(FlatSplitSystem ss, FlatSplitSystem ss2) {
    ...
    public static Set<Integer> getCommon(FlatSplitSystem ss, FlatSplitSystem ss2) {
        Set<Integer> uniq = new HashSet();
        boolean[][] splits = ss.getSplits();
        boolean[] active = ss.getActive();
        System.out.println(splits.length);
