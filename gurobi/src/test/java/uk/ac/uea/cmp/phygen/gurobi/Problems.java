...
public class Problems {
    ...
    public static Problem simpleQuadratic() {
        ...
        // Create the variables
        Variable x = new Variable("x", 0.1, new Bounds(0.0, Bounds.BoundType.LOWER), Variable.VariableType.CONTINUOUS);
        Variable y = new Variable("y", 0.9, new Bounds(0.0, Bounds.BoundType.LOWER), Variable.VariableType.CONTINUOUS);
        ...
        // Set objective: minimize -x - y + 4
        Expression objExpr = new Expression().addTerm(0.4, y, x).addTerm(0.4, x, y);
        Objective objective = new Objective("z", Objective.ObjectiveDirection.MINIMISE, objExpr);
        ...
        constraints.add(new Constraint("eq",
                new Expression().addTerm(1.0, x).addTerm(1.0, y).addConstant(1.0),
                Constraint.Relation.EQUAL,
                0.0));

        Problem problem = new Problem("simple_quadratic", variables, constraints, objective);
        problem.setInitialPoint(true);
